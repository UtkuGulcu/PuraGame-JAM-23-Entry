...
public class Spawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            int randEnemy = Random.Range(0, humanPrefab.Length);
            int randSpawnPoint = Random.Range(0, spawnPoints.Length);


            GameObject obj = Instantiate(humanPrefab[randEnemy], spawnPoints[randSpawnPoint].position, transform.rotation);
            objects.Add(obj);
